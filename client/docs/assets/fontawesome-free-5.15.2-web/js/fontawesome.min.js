...
!(function () {
	...
	function jt(t) {
		...
		m && (w.attributes[tt] = ''),
			s && w.children.push({ tag: 'title', attributes: { id: w.attributes['aria-labelledby'] || 'title-'.concat(f || kt()) }, children: [s] });
		var k,
			A,
			C,
			O,
			...
			B,
			G,
			K = $({}, w, { prefix: r, iconName: i, main: n, mask: a, maskId: l, transform: o, symbol: c, styles: $({}, x, u.styles) }),
			J =
				a.found && n.found
					? ((C = (k = K).children),
					  (O = k.attributes),
					  ...
					  (T = { tag: 'g', attributes: $({}, R.inner), children: [Et($({ tag: E.tag, attributes: $({}, E.attributes, R.path) }, _))] }),
					  (Y = { tag: 'g', attributes: $({}, R.outer), children: [T] }),
					  (H = 'mask-'.concat(N || kt())),
					  (F = 'clip-'.concat(N || kt())),
					  (D = {
							tag: 'mask',
							attributes: $({}, zt, { id: H, maskUnits: 'userSpaceOnUse', maskContentUnits: 'userSpaceOnUse' }),
							children: [I, Y],
					  }),
					  (U = {
							tag: 'defs',
							children: [{ tag: 'clipPath', attributes: { id: F }, children: ((A = L), 'g' === A.tag ? A.children : [A]) }, D],
					  }),
					  C.push(U, {
							tag: 'rect',
							attributes: $({ fill: 'currentColor', 'clip-path': 'url(#'.concat(F, ')'), mask: 'url(#'.concat(H, ')') }, zt),
					  }),
									...
									children: [
										{
											tag: 'g',
											attributes: $({}, o.inner),
											children: [{ tag: a.icon.tag, children: a.icon.children, attributes: $({}, a.icon.attributes, o.path) }],
										},
									],
								});
							} else e.push(a.icon);
				  ...
				  [
						{
							...
							children: [
								{
									tag: 'symbol',
									attributes: $({}, B, { id: !0 === G ? ''.concat(q, '-').concat(et.familyPrefix, '-').concat(V) : G }),
									children: X,
								},
							],
						},
	...
	function Lt(t) {
		...
		var x = [];
		return (
			x.push({ tag: 'span', attributes: l, children: [e] }), i && x.push({ tag: 'span', attributes: { class: 'sr-only' }, children: [i] }), x
		);
	}
	var Rt = function () {},
		...
		Tt = function (t) {
			It.mark(''.concat(_t, ' ').concat(t, ' ends')),
				It.measure(''.concat(_t, ' ').concat(t), ''.concat(_t, ' ').concat(t, ' begins'), ''.concat(_t, ' ').concat(t, ' ends'));
		},
		Yt = {
			begin: function (t) {
				return (
			...
			icon: Array.isArray(a)
				? {
						...
						children: [
							{
								tag: 'path',
								attributes: { class: ''.concat(et.familyPrefix, '-').concat(Y.SECONDARY), fill: 'currentColor', d: a[0] },
							},
							{ tag: 'path', attributes: { class: ''.concat(et.familyPrefix, '-').concat(Y.PRIMARY), fill: 'currentColor', d: a[1] } },
						],
				  }
		...
		return ~a.extra.classes.indexOf(j)
			? (function (t, e) {
					...
					return (
						...
						vt.resolve([t, Lt({ content: t.innerHTML, width: i, height: o, transform: a, title: n, extra: r, watchable: !0 })])
					);
			  })(t, a)
			: ((i = t),
			  (o = (e = a).iconName),
				...
				return Ee({ type: 'counter', content: t }, function () {
					return (
						...
						(function (t) {
							...
							content: t.toString(),
							title: a,
							extra: { attributes: c, styles: l, classes: [''.concat(et.familyPrefix, '-layers-counter')].concat(d(i)) },
						})
					);
				});
			},
			layer: function (t) {
				...
				return Ee({ type: 'layer' }, function () {
					...
					return (
						...
						[{ tag: 'span', attributes: { class: [''.concat(et.familyPrefix, '-layers')].concat(d(n)).join(' ') }, children: e }]
					);
				});
			},
			toHtml: Zt,
